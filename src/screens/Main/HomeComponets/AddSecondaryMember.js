...
const AddSecondaryMember = ({route}) => {
  ...
  const handleApi = async () => {
    ...
    //   Toast.show('Please enter valid emergency number2');
      ...
      Toast.show(
        'Please upload your Salary slip / Company authentication letter',
      );
    } else {
      // else {
      setLoader(true);
      ...
      <ScrollView style={styles.main}>
        <KeyboardAwareScrollView
          ...
          <View style={{marginTop: 0}}>
            <Text style={styles.heading}>First Name<Text style={{color: 'red'}}> *</Text></Text>
          ...
          <View style={{marginTop: 15}}>
            <Text style={styles.heading}>Last Name<Text style={{color: 'red'}}> *</Text></Text>
            <View style={styles.inputView}>
              <TextInput
                value={lastName}
          ...
          <View style={{marginTop: 15}}>
            <Text style={styles.heading}>Phone Number1<Text style={{color: 'red'}}> *</Text></Text>
            <View style={styles.inputView}>
              <TextInput
                value={phone}
                onChangeText={val => {
          ...
          <View style={{marginTop: 15}}>
            <Text style={styles.heading}>Emergency Number1<Text style={{color: 'red'}}> *</Text></Text>
            <View style={styles.inputView}>
              <TextInput
          ...
          <View style={{marginTop: 15}}>
            <Text style={styles.heading}>DOB<Text style={{color: 'red'}}> *</Text></Text>
            <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            <Upload />
            {photo ? (
              <Text numberOfLines={1} style={[styles.place, {marginRight: 20}]}>
                {photoName}
              </Text>
            ) : (
            ...
            {salary ? (
              ...
              <View style={styles.row}>
                <Text style={styles.place}>
                  {'Salary Slip / Company Auth Letter'}
                </Text>
                <Text style={{color: 'red'}}>*</Text>
              </View>
            )}
          ...
          <View style={styles.buttonView}>
            <TouchableOpacity onPress={() => handleApi()} style={styles.touch}>
